/* FILE THAT RENDERS PRESENTATION OF THE MODEL TO USER. */
...
class RecipeView extends View {
  ...
  addHandlerRender(handler) {
    // ARRAY TO WATCH FOR URL ID (#) CHANGE, PAGE FIRST LOAD AND FIRE FUNCTION
  ...
  addHandlerUpdateServings(handler) {
    ...
    this._parentElement.addEventListener('click', function (e) {
      ...
      if (!btn) return;
      // STORE THE DATASET PROPERTY TO KNOWS VALUE TO INCREASE OR DECREASE
  ...
  addHandlerAddBookmark(handler) {
    // EVENT DELEGATION TO WATCH FOR PARENT ELEMENT
    this._parentElement.addEventListener('click', function (e) {
    ...
    return `
      ...
      this._data.bookmarked ? '-fill' : ''
        ...
        <ul class="recipe__ingredient-list">
            ${/* LOOPING THROUGH INGREDIENTS ARRAY */ ''}
            ${this._data.ingredients
              .map(this._generateMarkupIngredient)
              .join('')}${
      /* TRANSFORMING THE ARRAY OF STRING INTO A STRING */ ''
    }
        </ul>
        </div>
